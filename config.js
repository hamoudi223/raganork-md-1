...
const baseConfig = {
    ...
    ANTIWORD_WARN: process.env.ANTIWORD_WARN || '4',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;𝝃𝝂𝝐𝜼⌯;0;https://files.catbox.moe/qnecuh.jpeg;https://chat.whatsapp.com/KXp1kIrU5SUDNj2Xg9lgOU',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.NOT_ALLOWED || '852',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.',
    STICKER_DATA: process.env.STICKER_DATA || "𝝃𝝂𝝐𝜼⌯",
